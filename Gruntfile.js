  ...
  grunt.initConfig({
    ...
    watch: {
      ...
      jadeIndex: {
        ...
        tasks: ['newer:jade', 'wiredep', 'includeSource:dist']
      },
      html: {
        files: ['<%= yeoman.app %>/**/partials/**/*.html'],
        tasks: ['newer:copy:partials', 'ngtemplates']
      },
      jade: {
        files: ['<%= yeoman.app %>/**/partials/**/*.jade'],
    ...
    // Store all the HTML partials into a minified app.templates.js
    ngtemplates: {
      app:          {
        cwd:        '.tmp',
        src:        '**/partials/**/*.html',
